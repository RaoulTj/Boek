...
Voor een RC-kring geldt:
  ...
  De gegevens invullen in de DV geeft:
  \begin{align}
   \dfrac{dU(t)}{dt} &= 2 \cdot \dfrac{dI}{dt} + 200 \cdot  I\\
   \dfrac{d}{dt}(175) &= 2 \cdot \dfrac{dI}{dt} + 200 \cdot  I \\
   0 &= 2 \cdot \dfrac{dI}{dt} + 200 \cdot  I
  \end{align}
...
De waarde voor $\lambda$ invullen in de homogene oplossing geeft;
\begin{align}
 I = Ce^{-100t} \qquad \text{met } C \in \mathbb{R}
\end{align}

De gegeven voorwaarden gebruiken om C te bepalen.  $I(0) = 3$
