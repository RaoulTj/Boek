...
De waardes voor $A$  invullen in de particuliere oplossing geeft:
\begin{align}
  y_p = -\dfrac{1}{13}e^{3x}x
\end{align}

De algemene oplossing bestaat uit een optelling van de homogene oplossing en de particuliere oplossing.
\begin{align}
 y &= y_h + y_p \\
 y &=  e^{-\dfrac{1}{2}x}\left(C_1\cos\left(\dfrac{1}{2}\sqrt{3}x\right) + C_2\sin \left( \dfrac{1}{2}\sqrt{3}x \right)\right)  -\dfrac{1}{13}e^{3x}x \qquad \text{met } C \in \mathbb{R}
\end{align}
```
````
