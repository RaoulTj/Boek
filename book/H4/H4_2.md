...
\begin{align}
 ...
 2A- 8Ax -8B +4Ax^2 +4Bx +4D&= 3x^2 - 2x\\
...
\begin{align}
  2 \cdot \dfrac{3}{4} -8 \cdot \dfrac{3}{2}  +4D &= 0\\
  \dfrac{6}{4} - \dfrac{24}{2}  +4D &= 0\\
  \dfrac{3}{2} - \dfrac{24}{2}  +4D &= 0\\
  - \dfrac{21}{2}  +4D &= 0\\
  4D &= \dfrac{21}{2}\\
  D&= \dfrac{21}{8}
\end{align}
...
De waardes voor $A$, $B$ en $D$ invullen in de particuliere oplossing geeft:
\begin{align}
 y_p = \dfrac{3}{4}x^2 + \dfrac{3}{2}x + \dfrac{21}{8}
\end{align}

De algemene oplossing bestaat uit een optelling van de homogene oplossing en de particuliere oplossing.
\begin{align}
 y &= y_h + y_p \\
 y &= y = C_1e^{2 x} + C_2xe^{2 x} + \dfrac{3}{4}x^2 + \dfrac{3}{2}x + \dfrac{21}{8}\qquad \text{met } C_{1,2} \in \mathbb{R}
\end{align}
```
````
...
De oplossingen van de karakteristieke vergelijking zijn:
\begin{align}
  \lambda_{1,2} &= \dfrac{4 \pm i\sqrt{7}}{2 \cdot 1}\\
  \lambda_{1,2} &= \dfrac{4}{2} \pm i \dfrac{\sqrt{7}}{2} \\
 \lambda_{1,2} &= 2 \pm i \dfrac{1}{2}\sqrt{7}
\end{align}
...
\begin{align}
 y_h = e^{2x}\left(C_1\cos\left(\dfrac{1}{2}\sqrt{7}x\right) + C_2\sin \left( \dfrac{1}{2}\sqrt{7}x \right)\right) \qquad  \text{met } C_{1,2} \in \mathbb{R}
\end{align}
