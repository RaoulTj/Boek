...
\begin{align}
 -4 \cdot \dfrac{1}{D^2 + 2D+1} \cdot   \cos(2x)
\end{align}

$-2$ invullen:

\begin{align}
 -4 \cdot \dfrac{1}{-2^2 + 2D+1} \cdot  \cos(2x) \\
 -4 \cdot \dfrac{1}{-4 + 2D+1} \cdot \cos(2x) \\
 -4 \cdot \dfrac{1}{2D-3} \cdot \cos(2x) 
\end{align}

Merkwaardig product gebruiken:
\begin{align}
 -4 \cdot \dfrac{2D+3}{4D^2-9} \cdot \cos(2x) \\
\end{align}

$-2$ invullen:
\begin{align}
 -4 \cdot \dfrac{2D+3}{4\cdot -2^2-9} \cdot \cos(2x) \\
 -4 \cdot  \dfrac{1}{4\cdot -4 -9}(2D+3) \cdot  \cos(2x) \\
 -4 \cdot  \dfrac{1}{-25}\cdot (2D+3) \cdot  \cos(2x) \\
 \dfrac{4}{25}\cdot (2D+3) \cdot  \cos(2x)
\end{align}

Vermenigvuldigen en differentiëren:
\begin{align}
 \dfrac{4}{25}\cdot (2 \cdot -2\sin(2x) + 3 \cos(2x)) \\
 \dfrac{4}{25}\cdot (2 \cdot -2\sin(2x) + 3 \cos(2x)) \\
 \dfrac{-16}{25}\sin(2x) + \dfrac{12}{25} \cos(2x) \\
\end{align}
```
...
:class: dropdown
  ...
  ````{dropdown} Voorbeeld 3: Goniometrische functies
  :class: dropdown
