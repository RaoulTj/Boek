...
\begin{align}
 y = e^{-\dfrac{1}{2}x}\left(C_1\cos\left(\dfrac{1}{2}\sqrt{3}x\right) + C_2\sin \left( \dfrac{1}{2}\sqrt{3}x \right)\right) \qquad  \text{met } C_{1,2} \in \mathbb{R}
\end{align}
...
De homogene D.V. wordt:
\begin{align}
 2\dfrac{d^2y}{dx^2}-6\dfrac{dy}{dx} +4y =  0
\end{align}
...
\begin{align*}
 2\dfrac{d^2y}{dx^2} + \dfrac{dy}{dx} + 2y = 10 \sin(x)
\end{align*}
...
\begin{align}
 ...
 (2\lambda^2 +1 \lambda + 2 )\cdot Ce^{\lambda x}  &= 0
\end{align}
...
\begin{align}
 y_h = e^{-\dfrac{1}{4}x}\left(C_1\cos\left(\dfrac{1}{4}\sqrt{15}x\right) + C_2\sin \left( \dfrac{1}{1}\sqrt{15}x \right)\right) \qquad  \text{met } C_{1,2} \in \mathbb{R}
\end{align}
...
\begin{align}
 \dfrac{dy_p}{dx} = A \cos(x) -B \sin(x) \\
 \dfrac{d^2y_p}{dx^2} = -A \sin (x) -B \cos(x)
\end{align}

Invullen in de D.V. geeft:
\begin{align}
 2 \cdot (-A \sin(x) -B \cos(x)) +   (A\cos(x) - B \sin(x)) + 2  \cdot  (A \sin(x) + B \cos(x) ) &= 10\sin(x) \\
 -2A\sin(x) - 2B\cos(x) + A\cos(x) - B\sin(x) + 2A \sin(x) + 2B \cos(x)  &= 10\sin(x) \\
 (-B)\sin(x) + (A)\cos(2x) &= 10\sin(x)
\end{align}
