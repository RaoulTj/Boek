...
Dus,
\begin{align}
 \dfrac{dy_p}{dx} &=  3Ae^{3x} x + Ae^{3x} = A(3x+1)e^{3x}\\
 \dfrac{d^2y_p}{dx^2} &=  9Ae^{3x} x + 3Ae^{3x} + Ae^{3x} = A(9x+4)e^{3x}\\
\end{align}

Invullen in de D.V. geeft:
\begin{align}
 A(9x+4)e^{3x} + 1 \cdot (A(3x+1)e^{3x}) - 12 \cdot ((Ax)e^{3x})  &= 5e^{3x} \\
 (9Ax+4A)e^{3x} + (3Ax+A)e^{3x} - (12A)e^{3x}  &= 5e^{3x}
\end{align}
